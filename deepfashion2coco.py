...
for num in tqdm(range(1, num_images+1)):
    json_name = 'D:\deepfashion2\validation\annos' + str(num).zfill(6)+'.json'
    image_name = 'D:\deepfashion2\validation\image' + str(num).zfill(6)+'.jpg'
...
json_name = 'D:\deepfashion2\validation\val.json'
