...
for num in tqdm(range(1, num_images+1)):
    json_name = 'D:\deepfashion2\train\annos' + str(num).zfill(6)+'.json'
    image_name = 'D:\deepfashion2\train\image' + str(num).zfill(6)+'.jpg'
...
json_name = 'D:\deepfashion2\train\train.json'
